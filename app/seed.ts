...
export default async function handler() {
  ...
  await prisma.restaurant.createMany({
    data: [
      // INDIAN //
      {
        ...
        price_category: PRICE_CATEGORY.REGULAR,
        description:
      ...
      },
      {
        ...
        price_category: PRICE_CATEGORY.CHEAP,
        description:
      ...
      },
      {
        ...
        price_category: PRICE_CATEGORY.EXPENSIVE,
        description:
  ...
  for (const restaurant of restaurants) {
    await prisma.table.createMany({
      data: [
        { restaurant_id: restaurant.id, seats: 2 },
        { restaurant_id: restaurant.id, seats: 2 },
        { restaurant_id: restaurant.id, seats: 2 },
        { restaurant_id: restaurant.id, seats: 2 },
        { restaurant_id: restaurant.id, seats: 2 },
  ...
  await prisma.item.createMany({
    data: [
      ...
      },
      {
        name: "Orata ai Porri",
        description:
          "Pan seared sea bream filet with sautéed leeks, served over a wild rice medley and reens",
        price: 32.0,
        restaurant_id: laBartolaId,
      },
      {
  ...
  await prisma.review.createMany({
    data: [
      ...
      {
        text: "Restaurant was loud and crowded. Food is not worth theprice",
        rating: 3,
        restaurant_id: eldoradoTacoId,
        user_id: userLaith.id,
      },
  ...
  // await prisma.table.createMany({
  //   data: [
  //     // Tables for restaurant bluRistoranteId
  //     {
  //       restaurant_id: bluRistoranteId,
  //       seats: 4,
  //     },
  ...
  //       seats: 4,
  //     },
  //     // Tables for restaurant elCatrinId
  //     {
  //       restaurant_id: elCatrinId,
  //       seats: 4,
  //     },
  ...
  //       seats: 4,
  //     },
  //     // Tables for restaurant eldoradoTacoId
  //     {
  //       restaurant_id: eldoradoTacoId,
  //       seats: 4,
  //     },
  ...
  //       seats: 4,
  //     },
  //     // Tables for restaurant vivaanId
  //     {
  //       restaurant_id: vivaanId,
  //       seats: 4,
  //     },
